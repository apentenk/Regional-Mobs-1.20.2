...
public class RegionalPickaxeItem extends PickaxeItem {
    ...
    public RegionalPickaxeItem(PickaxeItem base, Settings settings, boolean upgrade, StatusEffect bonusOne,
            StatusEffect bonusTwo) {
        super(base.getMaterial(), (int) (base.getAttackDamage() - base.getMaterial().getAttackDamage()), -2.8f,
                settings);

...
public class GrillagerEntity extends RegionalPillagerEntity{
    public static final String TEXTURE = "textures/entity/grillager.png";

    public GrillagerEntity(EntityType<? extends RegionalPillagerEntity> entityType, World world) {
    ...
    public void shoot(LivingEntity entity, LivingEntity target, ProjectileEntity projectile, float multishotSpray, float speed) {
        ...
        ((ArrowEntity)projectile).addEffect(new StatusEffectInstance(RegionalStatusEffects.SEARED, 200));

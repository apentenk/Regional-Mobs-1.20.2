...
public class ChillagerEntity extends RegionalPillagerEntity{
    public static final String TEXTURE = "textures/entity/chillager.png";

    public ChillagerEntity(EntityType<? extends RegionalPillagerEntity> entityType, World world) {
    ...
    public void shoot(LivingEntity entity, LivingEntity target, ProjectileEntity projectile, float multishotSpray, float speed) {
        ...
        ((ArrowEntity)projectile).addEffect(new StatusEffectInstance(RegionalStatusEffects.FROSTED, 200));
